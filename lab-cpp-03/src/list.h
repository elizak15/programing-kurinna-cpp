...
class List{
	...
	Train *trainList;
public:
    friend ostream& operator<<(ostream &outfile, List &list);
    friend istream& operator>>(istream &infile, List &list);
    //friend ofstream& operator <<(ofstream &outfile, List & list);
    //friend ifstream& operator >>(ifstream &infile, List & list);
